    ...
    <div className="flex justify-center">
      <div className="relative w-full max-w-[480px] aspect-[600/560] rounded-2xl overflow-hidden" style={{ background: "linear-gradient(145deg, #0D1117 0%, #161B22 50%, #0D1117 100%)" }}>
        <svg viewBox="0 0 600 560" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <path id="curveRight" d="M 370,105 C 530,60 590,250 510,405" fill="none" stroke="#C8985E" strokeWidth="1" opacity="0.35" markerEnd="url(#arrowG)" />
          ...
          <path id="curveBottom" d="M 470,495 C 400,555 200,555 130,495" fill="none" stroke="#C8985E" strokeWidth="1" opacity="0.35" markerEnd="url(#arrowG)" />
          <text fill="#C8985E" fontSize="11" fontWeight="300" opacity="0.55" fontStyle="italic">
            <textPath href="#curveBottom" startOffset="50%" textAnchor="middle">Impact</textPath>
          </text>

          <path id="curveLeft" d="M 90,405 C 10,250 70,60 230,105" fill="none" stroke="#C8985E" strokeWidth="1" opacity="0.35" markerEnd="url(#arrowG)" />
          <text fill="#C8985E" fontSize="11" fontWeight="300" opacity="0.55" fontStyle="italic">
            <textPath href="#curveLeft" startOffset="45%" textAnchor="middle">Authenticité</textPath>
          </text>

          <polygon points="300,155 165,385 435,385" fill="rgba(255,255,255,0.02)" stroke="rgba(255,255,255,0.12)" strokeWidth="1.2" />
